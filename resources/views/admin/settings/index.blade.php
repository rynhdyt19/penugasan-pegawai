                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                                    <div>
                                        <label
                                            ...
                                            (Terkunci)</label>
                                        <input type="text" value="{{ Auth::user()->nip ?? '199001012015011001' }}"
                                    ...
                                    <div>
                                        <label
                                            ...
                                            WhatsApp</label>
                                        <input type="text" name="kontak" value="{{ Auth::user()->kontak }}"
                                            class="w-full px-6 py-4 bg-gray-50/80 border-none focus:ring-2 focus:ring-indigo-500/20 rounded-2xl text-slate-700 font-semibold transition-all">
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="relative z-10">
                                        <p class="text-indigo-100 text-[10px] font-bold uppercase tracking-widest">Total
                                            Pegawai</p>
                                        <p class="text-4xl font-black mt-2">{{ $statistik['total_pegawai'] ?? 0 }}</p>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="relative z-10">
                                        ...
                                        <p class="text-4xl font-black mt-2">
                                            {{ number_format($statistik['total_jam_tugas'] ?? 0, 1) }}<span
