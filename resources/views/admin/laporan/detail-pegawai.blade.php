        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
            <div class="flex items-center gap-5">
                <div
                    ...
                    {{ substr($pegawai->name, 0, 2) }}
                </div>
                <div>
                    <h2 class="text-3xl font-extrabold text-gray-900 tracking-tight">{{ $pegawai->name }}</h2>
            ...
            <a href="{{ route('admin.laporan.rekap', ['bulan' => $bulan, 'tahun' => $tahun]) }}"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <div
                ...
                <div class="relative z-10">
                    ...
                    <h4 class="text-4xl font-black text-gray-900">{{ $statistik['total_tugas'] }}</h4>
                    <div
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <h4 class="text-4xl font-black text-emerald-600">{{ $statistik['total_jam'] }}<span
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <h4 class="text-4xl font-black text-purple-600">{{ $statistik['tugas_selesai'] }}</h4>
                    <div
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <h4 class="text-4xl font-black text-amber-500">{{ $statistik['tugas_aktif'] }}</h4>
                    <div
                            ...
                            <tr class="hover:bg-indigo-50/30 transition-colors group">
                                <td class="px-8 py-6">
                                    <div class="flex flex-col">
                                        <span
                                            class="text-sm font-black text-gray-900 mb-1 group-hover:text-indigo-600 transition-colors">{{ $p->tugas->nama_tugas }}</span>
                                        <div class="flex items-center gap-1.5 text-gray-400">
                                            ...
                                            <span
                                                class="text-[11px] font-medium tracking-wide italic">{{ $p->tugas->lokasi }}</span>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-8 py-6 text-center">
                                    <div class="flex flex-col items-center">
                                        <span
                                            class="text-[11px] font-black text-gray-700">{{ $p->tugas->tanggal->format('d M Y') }}</span>
                                        <span
                                            class="text-[10px] font-bold text-gray-400 uppercase mt-0.5">{{ $p->tugas->durasi }}
                                            Jam Kerja</span>
                                    </div>
                                </td>
                                <td class="px-8 py-6 text-center">
                                    <span
                                        class="px-4 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest border border-current {{ $p->tugas->prioritas_color }}">
                                        {{ $p->tugas->prioritas }}
                                    </span>
                                </td>
                                <td class="px-8 py-6 text-center">
                                    <span
                                        class="px-4 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest border border-current {{ $p->tugas->status_color }}">
                                        {{ $p->tugas->status }}
                                    </span>
                                </td>
                                <td class="px-8 py-6 text-right whitespace-nowrap">
                                    <span
                                        class="text-xs font-bold text-gray-400">{{ $p->assigned_at->format('d/m/Y') }}</span>
                                </td>
                            </tr>
                        @empty
                            <tr>
