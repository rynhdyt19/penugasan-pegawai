    ...
    <div class="space-y-6" x-data="notificationManager()">
        ...
        <div class="space-y-3">
            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div x-show="shouldShow(<?php echo e($notification->is_read ? 'true' : 'false'); ?>)"
                    ...
                    <div class="flex gap-4">
                        ...
                        <div class="flex-shrink-0">
                            <div
                                class="w-12 h-12 rounded-xl <?php echo e($notification->bg_class); ?> flex items-center justify-center">
                                <?php if($notification->type === 'success'): ?>
                                    <svg class="w-6 h-6 <?php echo e($notification->icon_class); ?>" fill="none"
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-3">
                                <div class="flex-1">
                                    <h3
                                        class="text-sm font-bold text-gray-900 <?php echo e(!$notification->is_read ? 'font-black' : ''); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\penugasan-pegawai\resources\views/admin/notifications/index.blade.php ENDPATH**/ ?>