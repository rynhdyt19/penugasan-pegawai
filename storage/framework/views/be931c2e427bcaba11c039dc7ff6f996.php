        ...
        <div class="login-card w-full max-w-md p-10 rounded-2xl shadow-2xl relative z-10">
            ...
            <div class="flex justify-center mb-6">
                <div class="w-20 h-20 bg-white rounded-full shadow-lg flex items-center justify-center">
                    <img src="<?php echo e(asset('gambar/bps_logo.png')); ?>" alt="Logo BPS" class="w-16 h-16 object-contain">
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\penugasan-pegawai\resources\views/auth/login.blade.php ENDPATH**/ ?>