            ...
            <div class="lg:col-span-3">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex items-center space-x-4">
                                    <?php if(Auth::user()->photo): ?>
                                        <img src="<?php echo e(asset('storage/' . Auth::user()->photo)); ?>" alt="Profile Photo"
                                    ...
                                    <div>
                                        ...
                                        <?php if(Auth::user()->photo): ?>
                                            <form action="<?php echo e(route('admin.settings.delete-photo')); ?>" method="POST"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="kontak"
                                            value="<?php echo e(old('kontak', Auth::user()->kontak)); ?>"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                    </div>
                ...
                <div id="content-notifications" class="tab-content hidden">
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                        ...
                        <div class="p-6">
                            <form action="<?php echo e(route('admin.settings.update-notifications')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                    ...
                                    <div class="flex items-start">
                                        <div class="flex items-center h-5">
                                            <input type="checkbox" name="email_notifications" id="email_notifications"
                                                <?php echo e($preferences['email_notifications'] ?? true ? 'checked' : ''); ?>
                                    ...
                                    <div class="flex items-start">
                                        <div class="flex items-center h-5">
                                            <input type="checkbox" name="system_alerts" id="system_alerts"
                                                <?php echo e($preferences['system_alerts'] ?? true ? 'checked' : ''); ?>
                ...
                <div id="content-appearance" class="tab-content hidden">
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                        ...
                        <div class="p-6">
                            <form action="<?php echo e(route('admin.settings.update-appearance')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('PUT'); ?>
                                ...
                                <div class="space-y-6">
                                    <div>
                                        ...
                                        <select name="theme"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                            <option value="light"
                                                <?php echo e(($appearance['theme'] ?? 'light') == 'light' ? 'selected' : ''); ?>>Terang
                                            </option>
                                            <option value="dark"
                                                <?php echo e(($appearance['theme'] ?? 'light') == 'dark' ? 'selected' : ''); ?>>Gelap
                                            </option>
                                            <option value="auto"
                                                <?php echo e(($appearance['theme'] ?? 'light') == 'auto' ? 'selected' : ''); ?>>
                                    ...
                                    <div>
                                        ...
                                        <select name="language"
                                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                                            <option value="id"
                                                <?php echo e(($appearance['language'] ?? 'id') == 'id' ? 'selected' : ''); ?>>Bahasa
                                                Indonesia</option>
                                            <option value="en"
                                                <?php echo e(($appearance['language'] ?? 'id') == 'en' ? 'selected' : ''); ?>>English
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p class="text-3xl font-bold text-blue-900 mt-2">
                                                <?php echo e($statistik['total_pegawai'] ?? 0); ?></p>
                                        </div>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p class="text-3xl font-bold text-purple-900 mt-2">
                                                <?php echo e(number_format($statistik['total_jam_tugas'] ?? 0, 1)); ?></p>
                                        </div>
