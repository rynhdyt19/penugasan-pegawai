...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Sistem Penjadwalan Pegawai'); ?> | BPS</title>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('gambar/favicon.ico')); ?>">
        ...
        <aside :class="mobileSidebar ? 'translate-x-0' : '-translate-x-full'"
            ...
            <div class="h-20 flex items-center px-8 mb-4">
                <div class="flex items-center gap-3">
                    <div
                        ...
                        <img src="<?php echo e(asset('gambar/bps_logo.png')); ?>" class="h-6 w-auto brightness-0 invert"
                            alt="Logo">
                    </div>
            ...
            <nav class="flex-1 overflow-y-auto custom-scrollbar px-6 space-y-1">
                ...
                <?php if(Auth::user()->isAdmin()): ?>
                    <a href="<?php echo e(route('admin.dashboard')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : 'text-gray-500'); ?> flex items-center space-x-3 px-4 py-3.5 rounded-2xl text-sm font-bold">
                    ...
                    <a href="<?php echo e(route('admin.pegawai.index')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('admin.pegawai.*') ? 'active' : 'text-gray-500'); ?> flex items-center space-x-3 px-4 py-3.5 rounded-2xl text-sm font-bold">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="<?php echo e(route('admin.tugas.index')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('admin.tugas.*') ? 'active' : 'text-gray-500'); ?> flex items-center space-x-3 px-4 py-3.5 rounded-2xl text-sm font-bold">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="<?php echo e(route('admin.penjadwalan.index')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('admin.penjadwalan.*') ? 'active' : 'text-gray-500'); ?> flex items-center space-x-3 px-4 py-3.5 rounded-2xl text-sm font-bold">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="<?php echo e(url('admin/laporan')); ?>"
                        class="sidebar-link <?php echo e(request()->is('admin/laporan*') ? 'active' : 'text-gray-500'); ?> flex items-center space-x-3 px-4 py-3.5 rounded-2xl text-sm font-bold">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('pegawai.dashboard')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('pegawai.dashboard') ? 'active' : 'text-gray-500'); ?> flex items-center space-x-3 px-4 py-3.5 rounded-2xl text-sm font-bold">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                        </svg>
                    ...
                    <a href="<?php echo e(route('pegawai.jadwal')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('pegawai.jadwal*') ? 'active' : 'text-gray-500'); ?> flex items-center space-x-3 px-4 py-3.5 rounded-2xl text-sm font-bold">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                        </svg>
                    ...
                    <a href="<?php echo e(route('pegawai.riwayat')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('pegawai.riwayat*') ? 'active' : 'text-gray-500'); ?> flex items-center space-x-3 px-4 py-3.5 rounded-2xl text-sm font-bold">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="<?php echo e(Auth::user()->isAdmin() ? route('admin.settings.index') : route('pegawai.settings.index')); ?>"
                ...
                <form method="POST" action="<?php echo e(route('logout')); ?>" class="mt-4 pt-4 border-t border-gray-50">
                    <?php echo csrf_field(); ?>
                    <button type="submit"
            ...
            <div class="p-6">
                <div class="flex items-center gap-3 p-3 bg-indigo-900 rounded-[1.5rem] shadow-xl shadow-indigo-200">
                    <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&background=fff&color=4F46E5"
                        class="w-10 h-10 rounded-xl shadow-sm">
                    <div class="flex flex-col overflow-hidden">
                        <p class="text-[11px] font-black text-white truncate"><?php echo e(Auth::user()->name); ?></p>
                        <p class="text-[9px] font-bold text-indigo-300 uppercase tracking-widest">
                            <?php echo e(Auth::user()->role); ?></p>
                    </div>
                </div>
            </div>
        </aside>
        ...
        <div class="flex-1 flex flex-col min-w-0">
            <header
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex flex-col">
                        <h2 class="text-sm font-black text-gray-900 uppercase tracking-[0.15em]"><?php echo $__env->yieldContent('header_title', 'Ringkasan'); ?></h2>
                    ...
                    <div class="flex items-center gap-3 pl-2">
                        <p class="text-[11px] font-black text-gray-400 text-right hidden sm:block">
                            ...
                            <span class="text-gray-900">
                                <?php echo e(\Carbon\Carbon::now('Asia/Makassar')->format('H:i')); ?>
...
<?php /**PATH C:\xampp\htdocs\penugasan-pegawai\resources\views/layouts/app.blade.php ENDPATH**/ ?>