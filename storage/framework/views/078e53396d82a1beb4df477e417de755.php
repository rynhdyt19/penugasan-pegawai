...
<?php $__env->startSection('title', 'Laporan & Monitoring'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="space-y-8 animate-in fade-in duration-700">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <a href="<?php echo e(route('admin.laporan.statistik')); ?>"
            ...
            <div class="relative z-10">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    <div class="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10">
                        ...
                        <form action="<?php echo e(route('admin.laporan.pdf')); ?>" method="GET" class="space-y-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-1">
                                    ...
                                    <select name="bulan"
                                        ...
                                        <?php for($i = 1; $i <= 12; $i++): ?>
                                            <option value="<?php echo e($i); ?>" class="text-gray-900"
                                                <?php echo e(date('n') == $i ? 'selected' : ''); ?>>
                                ...
                                <div class="space-y-1">
                                    ...
                                    <select name="tahun"
                                        ...
                                        <?php for($i = date('Y'); $i >= date('Y') - 5; $i--): ?>
                                            <option value="<?php echo e($i); ?>" class="text-gray-900"><?php echo e($i); ?>
                    ...
                    <div class="bg-white/5 backdrop-blur-md rounded-2xl p-6 border border-white/10">
                        ...
                        <form action="<?php echo e(route('admin.laporan.excel')); ?>" method="GET" class="space-y-4">
                            <div class="grid grid-cols-2 gap-4">
                                <div class="space-y-1">
                                    <label
                                        class="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-1">Bulan</label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\penugasan-pegawai\resources\views/admin/laporan/index.blade.php ENDPATH**/ ?>