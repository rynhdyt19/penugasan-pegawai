                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $tugas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4 border-r border-gray-200 whitespace-nowrap text-sm font-medium text-gray-900"
                                    title="<?php echo e($t->nama_tugas); ?>">
                                    <?php echo e(Str::limit($t->nama_tugas, 25, '...')); ?>

                                </td>
                                <td class="px-6 py-4 border-r border-gray-200 whitespace-nowrap text-sm text-gray-600">
                                    <?php echo e($t->tanggal->format('d M Y')); ?></td>
                                <td class="px-6 py-4 border-r border-gray-200 whitespace-nowrap text-sm text-gray-600">
                                    <?php echo e($t->lokasi); ?></td>
                                <td class="px-6 py-4 border-r border-gray-200 whitespace-nowrap text-sm text-gray-600">
                                    <?php echo e($t->durasi); ?> jam</td>
                                <td class="px-6 py-4 border-r border-gray-200 whitespace-nowrap">
                                    <span
                                        class="inline-flex px-3 py-1 text-xs font-semibold leading-5 rounded-full <?php echo e($t->prioritas_color); ?>">
                                        <?php echo e(ucfirst($t->prioritas)); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 border-r border-gray-200 whitespace-nowrap">
                                    <span
                                        class="inline-flex px-3 py-1 text-xs font-semibold leading-5 rounded-md <?php echo e($t->status_color); ?>">
                                        <?php echo e(ucfirst($t->status)); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 border-r border-gray-200 whitespace-nowrap text-sm text-gray-600">
                                    <?php if($t->penugasan->first()): ?>
                                        <div class="flex items-center">
                                            <div
                                                class="h-8 w-8 rounded-full bg-gray-200 flex items-center justify-center text-xs font-bold text-gray-500 mr-2">
                                                <?php echo e(substr($t->penugasan->first()->user->name, 0, 1)); ?>

                                            </div>
                                            <?php echo e($t->penugasan->first()->user->name); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="<?php echo e(route('admin.tugas.show', $t)); ?>"
                                        ...
                                        <a href="<?php echo e(route('admin.tugas.edit', $t)); ?>"
                                        ...
                                        <form action="<?php echo e(route('admin.tugas.destroy', $t)); ?>" method="POST" class="inline"
                                            id="delete-form-<?php echo e($t->id); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button" onclick="confirmDelete('<?php echo e($t->id); ?>')"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\penugasan-pegawai\resources\views/admin/tugas/index.blade.php ENDPATH**/ ?>