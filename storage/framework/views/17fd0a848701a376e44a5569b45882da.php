...
<?php $__env->startSection('content'); ?>
    <div class="max-w-3xl mx-auto py-12 px-4 animate-in fade-in slide-in-from-bottom-6 duration-700">
        <nav class="mb-4 flex items-center text-sm text-gray-400 space-x-2">
            <a href="<?php echo e(route('admin.tugas.index')); ?>" class="hover:text-indigo-600 transition">Data Tugas</a>
            <span>/</span>
        ...
        <div class="bg-white rounded-[2.5rem] shadow-2xl shadow-gray-200/60 border border-gray-100 overflow-hidden">
            <div class="p-8 sm:p-12">
                <form action="<?php echo e(route('admin.tugas.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                                        <p class="text-red-500 text-xs mt-2 italic font-medium"><?php echo e($message); ?></p>
                                    <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative flex items-center">
                                            <input type="number" name="durasi" value="<?php echo e(old('durasi', 1)); ?>" required
                                                min="1"
                                                class="w-full px-5 py-4 bg-gray-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 transition-all font-medium text-gray-900 shadow-inner">
                                            <span
                        ...
                        <div class="pt-4">
                            ...
                            <div class="space-y-6">
                                ...
                                <div x-data="{
                                    open: false,
                                    selected: '<?php echo e(old('prioritas', 'sedang')); ?>',
                                            ...
                                            <?php $__currentLoopData = ['rendah' => 'bg-emerald-400', 'sedang' => 'bg-amber-400', 'tinggi' => 'bg-orange-400', 'urgent' => 'bg-rose-500']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $dot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <button type="button"
                                                    ...
                                                    <span
                                                        ...
                                                        <?php echo e($val == 'rendah' ? 'Rendah (Standard)' : ($val == 'sedang' ? 'Sedang (Normal)' : ($val == 'tinggi' ? 'Tinggi (Penting)' : 'Urgent (Segera)'))); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\penugasan-pegawai\resources\views/admin/tugas/create.blade.php ENDPATH**/ ?>