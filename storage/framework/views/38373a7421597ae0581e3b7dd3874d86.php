...
<?php $__env->startSection('header_title', 'Ringkasan Kerja'); ?>
...
<div class="p-6 max-w-7xl mx-auto">
    <div class="mb-10">
        ...
        <p class="text-sm font-medium text-gray-500 mt-1">
            Selamat bekerja kembali, <span class="text-indigo-600 font-bold"><?php echo e(Auth::user()->name); ?></span>! 👋
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        <div class="group bg-blue-600 rounded-[2rem] p-6 text-white shadow-lg shadow-blue-200 hover:scale-[1.02] transition-all duration-300">
            ...
            <p class="text-4xl font-black mt-1"><?php echo e($tugasAktif); ?></p>
        </div>
        ...
        <div class="group bg-emerald-500 rounded-[2rem] p-6 text-white shadow-lg shadow-emerald-200 hover:scale-[1.02] transition-all duration-300">
            ...
            <p class="text-4xl font-black mt-1"><?php echo e($tugasSelesai); ?></p>
        </div>
        ...
        <div class="group bg-indigo-600 rounded-[2rem] p-6 text-white shadow-lg shadow-indigo-200 hover:scale-[1.02] transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="text-right">
                    ...
                    <span class="text-[10px] font-bold text-indigo-200 italic">Maks <?php echo e(Auth::user()->max_tugas_mingguan); ?></span>
                </div>
            </div>
            <p class="text-xs font-bold text-indigo-100 uppercase tracking-wider">Minggu Ini</p>
            <p class="text-4xl font-black mt-1"><?php echo e($tugasMingguIni); ?></p>
        </div>
        ...
        <div class="group bg-orange-500 rounded-[2rem] p-6 text-white shadow-lg shadow-orange-200 hover:scale-[1.02] transition-all duration-300">
            <div class="flex items-center justify-between mb-4">
                ...
                <div class="text-right">
                    ...
                    <span class="text-[10px] font-bold text-orange-200 italic">Maks <?php echo e(Auth::user()->max_tugas_bulanan); ?></span>
                </div>
            </div>
            <p class="text-xs font-bold text-orange-100 uppercase tracking-wider">Bulan Ini</p>
            <p class="text-4xl font-black mt-1"><?php echo e($tugasBulanIni); ?></p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-[2.5rem] border border-gray-100 p-8 shadow-sm">
            <div class="flex items-center justify-between mb-8">
                ...
                <span class="px-3 py-1 bg-indigo-50 text-indigo-600 text-[10px] font-black rounded-lg uppercase">
                    Kapasitas <?php echo e($bebanKerja['mingguan']['percentage']); ?>%
                </span>
            </div>
            
            <div class="flex justify-between items-end mb-3">
                <span class="text-4xl font-black text-gray-900 tracking-tighter"><?php echo e($bebanKerja['mingguan']['current']); ?> <span class="text-lg text-gray-300 font-medium">/ <?php echo e($bebanKerja['mingguan']['max']); ?></span></span>
                <span class="text-[11px] font-bold text-indigo-500 uppercase">Sisa <?php echo e($bebanKerja['mingguan']['sisa']); ?> Slot</span>
            </div>
            ...
            <div class="w-full bg-gray-50 rounded-2xl h-4 overflow-hidden p-1 border border-gray-100">
                <div class="h-full rounded-xl bg-indigo-600 transition-all duration-1000"
                     style="width: <?php echo e(min($bebanKerja['mingguan']['percentage'], 100)); ?>%"></div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[2.5rem] border border-gray-100 p-8 shadow-sm">
            <div class="flex items-center justify-between mb-8">
                ...
                <span class="px-3 py-1 bg-emerald-50 text-emerald-600 text-[10px] font-black rounded-lg uppercase">
                    Kapasitas <?php echo e($bebanKerja['bulanan']['percentage']); ?>%
                </span>
            </div>
            
            <div class="flex justify-between items-end mb-3">
                <span class="text-4xl font-black text-gray-900 tracking-tighter"><?php echo e($bebanKerja['bulanan']['current']); ?> <span class="text-lg text-gray-300 font-medium">/ <?php echo e($bebanKerja['bulanan']['max']); ?></span></span>
                <span class="text-[11px] font-bold text-emerald-500 uppercase">Sisa <?php echo e($bebanKerja['bulanan']['sisa']); ?> Slot</span>
            </div>

            <div class="w-full bg-gray-50 rounded-2xl h-4 overflow-hidden p-1 border border-gray-100">
                <div class="h-full rounded-xl bg-emerald-500 transition-all duration-1000"
                     style="width: <?php echo e(min($bebanKerja['bulanan']['percentage'], 100)); ?>%"></div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-[2.5rem] border border-gray-100 shadow-sm overflow-hidden">
        <div class="px-8 py-6 border-b border-gray-50 flex justify-between items-center bg-gray-50/30">
            ...
            <a href="<?php echo e(route('pegawai.jadwal')); ?>" class="text-[10px] font-black text-indigo-600 border-2 border-indigo-100 px-5 py-2.5 rounded-xl hover:bg-indigo-600 hover:text-white hover:border-indigo-600 transition-all uppercase tracking-widest">
                Lihat Semua
            </a>
        </div>
        ...
        <div class="p-8">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <?php $__empty_1 = true; $__currentLoopData = $tugasMendatang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penugasan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="group relative flex items-center justify-between p-5 border border-gray-50 rounded-3xl hover:border-indigo-100 hover:bg-indigo-50/20 transition-all duration-300">
                        <div class="flex items-center gap-5">
                            <div class="w-14 h-14 bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center transition-transform group-hover:scale-105">
                                <span class="text-[9px] font-black text-indigo-500 uppercase leading-none mb-1"><?php echo e($tugas->tanggal->translatedFormat('M')); ?></span>
                                <span class="text-xl font-black text-gray-900 leading-none"><?php echo e($tugas->tanggal->format('d')); ?></span>
                            </div>
                            <div>
                                <h4 class="font-bold text-gray-900 group-hover:text-indigo-600 transition-colors"><?php echo e($tugas->nama_tugas); ?></h4>
                                <div class="flex items-center gap-4 mt-2 text-[11px] font-bold text-gray-400">
                                    <span class="flex items-center gap-1.5">📍 <?php echo e($tugas->lokasi); ?></span>
                                    <span class="flex items-center gap-1.5 text-indigo-400">⏱️ <?php echo e($tugas->durasi); ?> Jam</span>
                                </div>
                            </div>
                        </div>
                        
                        <div class="flex flex-col items-end">
                            <span class="px-2 py-1 text-[9px] font-black uppercase tracking-tighter rounded-md <?php echo e($tugas->prioritas_color); ?> mb-2">
                                <?php echo e($tugas->prioritas); ?>

                            </span>
                            <a href="<?php echo e(route('pegawai.tugas.detail', $tugas)); ?>" class="text-[10px] font-black text-indigo-600 uppercase tracking-widest hover:underline decoration-2 underline-offset-4 transition-all">
                                Detail →
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\penugasan-pegawai\resources\views/pegawai/dashboard.blade.php ENDPATH**/ ?>