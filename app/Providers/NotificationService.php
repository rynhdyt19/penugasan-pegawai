...
class NotificationService
{
     ...
     */
    public static function create(User $user, string $title, string $message, string $type = 'info', ?string $url = null, ?string $icon = null): Notification
    {
     ...
     */
    public static function notifyAdmin(string $title, string $message, string $type = 'info', ?string $url = null): void
    {
     ...
     */
    public static function sendBulk(array $userIds, string $title, string $message, string $type = 'info', ?string $url = null): void
    {
     ...
     */
    public static function notifyBySeksi(string $seksi, string $title, string $message, string $type = 'info', ?string $url = null): void
    {
